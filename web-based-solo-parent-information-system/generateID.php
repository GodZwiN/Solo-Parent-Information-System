            ...
            <div class="col me-3">
                <div class="row px-1 py-2 d-block" id="frontID">
                    <div class="row" id="header">
                        ...
                        <div class="col-2">
                            <img src="images/cswdoLogo.png" alt="" id="logo">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mt-3" style="font-size: 8px;">
                        <div class="col-6 position-relative">
                            <img class="position-absolute" src="signatures/cswdoOfficerSignature.png" alt="" height="40px" style="bottom: 5px; left: 15px">
                            <p class="text-center text-decoration-underline fw-bold"><?=$_COOKIE['cswdoOfficer']?></p>
                            <p class="text-center ">City Social Welfare & Development Officer</p>
                        </div>
                        <div class="col-6 position-relative">
                            <img class="position-absolute" src="signatures/cityMayorSignature.png" alt="" height="40px" style="bottom: 5px; left: 32px">
                            <p class="text-center text-decoration-underline fw-bold">HON. <?=$_COOKIE['cityMayor']?></p>
                            <p class="text-center">City Mayor</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row px-1 py-2 d-block position-relative" id="backID"> 
                    ...
                    <div class="row position-absolute mb-1" id="lastRow" >
                        <div class="col-7 text-center">
                            <img class="position-absolute" src="signatures/verifierSignature.png" alt="" height="35px" style="bottom: 15px; left: 35px">
                            <span class="fw-bold "style="font-size: 8px"><?=$_COOKIE['idVerifier']?></span>
                            <p style="font-size:8px; border-top: 1px solid black">Validator</p>
                        </div>
                        <div class="col-1"></div>
