            ...
            if (isPasswordCorrect($currentPasswordConfirmation, $_SESSION['loggedAccount']['Password'])) { 
                if (empty($newPassword)) {
                    ...
                    if (!mysqli_query($connection, updateAccountProfile($_SESSION['loggedAccount']['AccountID'], $username, $firstName, $middleName, $lastName))) {
                        ...
                        addAccountUpdateAudit($_SESSION['loggedAccount']['FirstName'],$_SESSION['loggedAccount']['LastName'],$_SESSION['loggedAccount']['Username']);
            ...
            <form action="accountSettings.php" method="POST">
                ...
                <div class="row mb-4 ps-5">
                    <div class="col-11">
                        ...
                        <input autocomplete="off" type="text" class="form-control" name="username" id="username" placeholder="Enter username" required value="<?= $username ?>">
                ...
                <div class="row mb-4 ps-5">
                    <div class="col-11">
                        ...
                        <input autocomplete="off" type="text" class="form-control" name="firstName" id="firstName" placeholder="Enter first name" required value="<?= $firstName ?>">
                ...
                <div class="row mb-4 ps-5">
                    <div class="col-11">
                        ...
                        <input autocomplete="off" type="text" class="form-control" name="middleName" id="middleName" placeholder="Enter middle name" value="<?= $middleName ?>">
                ...
                <div class="row mb-4 ps-5">
                    <div class="col-11">
                        ...
                        <input autocomplete="off" type="text" class="form-control" name="lastName" id="lastName" placeholder="Enter last name "required value="<?= $lastName ?>">
