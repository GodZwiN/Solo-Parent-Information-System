...
$phoneNumber = intval(substr($soloParentRecord['PhoneNumber'], 3));
                ...
                if (!$isChildAlreadyExist){
                    if (!(mysqli_query($connection, updateSoloParentRecord($soloParentID,$controlNumber, $firstName, $middleName, $lastName, $sex, $birthdate, $barangay, $streetAddress, $occupation, $phoneNumber, $natureOfSoloParent, $pwdStatus, $fourPsStatus, $remarks)))) {
                        ...
                        if ($isAllChildRecordAdded) {
                            ...
                            addEditSoloParentAudit($_SESSION['loggedAccount']['FirstName'],$_SESSION['loggedAccount']['LastName'],$soloParentFullName, $controlNumber, $_SESSION['loggedAccount']['Username']);
                    ...
                    <form action="#" method="POST" id="updateSoloParentForm">
                        ...
                        <div class="row g-2">
                            <div class="col-lg-3 mb-3">
                                ...
                                <input autocomplete="off" readonly type="text" class="form-control" id="controlNumber" name="controlNumber" placeholder="SAL XX-XX-XX" value="<?= $controlNumber?>" required>
                                <span class="error-message text-danger"><?= $controlNumberErrorMessage ?></span>
                            </div>
                            <div class="col-lg-3 mb-3">
                                <label for="firstName" class="form-label">First Name</label>
                                <input autocomplete="off" type="text" class="form-control" id="firstName" name="firstName" placeholder="Juan" value="<?= $firstName?>" required>
                                <span class="error-message text-danger" id="firstNameErrorMessage"><?= $firstNameErrorMessage ?></span>
                            </div>
                            <div class="col-lg-3 mb-3">
                                <label for="middleName" class="form-label">Middle Name</label>
                                <input autocomplete="off" type="text" class="form-control" id="middleName" name="middleName" placeholder="San Juan" value="<?= $middleName?>">
                                <span class="error-message text-danger " id="middleNameErrorMessage"><?= $middleNameErrorMessage ?></span>
                            </div>
                            <div class="col-lg-3 mb-3">
                                <label for="lastName" class="form-label">Last Name</label>
                                <input autocomplete="off" type="text" class="form-control" id="lastName" name="lastName" placeholder="Dela Cruz" value="<?= $lastName?>" required>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col mb-3">
                                ...
                                <input autocomplete="off" type="text" class="form-control" id="occupation" name="occupation" placeholder="Ex. Production Operator" value="<?= $occupation?>" required>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col mb-3">
                                ...
                                <input autocomplete="off" type="text" class="form-control" id="streetAddress" name="streetAddress" placeholder="Block # Lot # Sample St. Sample Village" value="<?= $streetAddress?>" required>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-lg-<?=$columnSize?> mb-3">
                                ...
                                <input autocomplete="off" type="text" name="membershipStatus" id="membershipStatus" class="form-control" disabled value="<?= $membershipStatus ?>">
                            </div>
                            <?php 
                            ...
                            <div id="childFields">
                                <div class="row g-2 mt-2">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control" id="child1FirstName" name="child1FirstName" placeholder="Pedro" required>
                                    </div>
                                    <div class="col-lg-4 mb-3">
                                        <label for="child1MiddleName" class="form-label">Middle Name</label>
                                        <input autocomplete="off" type="text" class="form-control" id="child1MiddleName" name="child1MiddleName" placeholder="San Juan" required>
                                    </div>
                                    <div class="col-lg-4 mb-3">
                                        <label for="child1LastName" class="form-label">Last Name</label>
                                        <input autocomplete="off" type="text" class="form-control" id="child1LastName" name="child1LastName" placeholder="Dela Cruz" required>
                                    </div>
                                </div>
                                <div class="row g-2">
                                    <div class="col-lg-4 mb-3">
...
<script>
    ...
    document.getElementById('middleName').onkeyup = function () {
        if (allLetter(document.getElementById('middleName')) || document.getElementById('middleName').value === '') {
