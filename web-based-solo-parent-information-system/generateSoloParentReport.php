        ...
        <div class="main-content p-5">
            ...
            <div class="row">
                ...
                if(isset($_GET['informativeMaterialExist'])){
                    echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                        Solo parent report upload failed. Solo parent report already exist.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            ...
            <div class="row mb-3 px-5 g-1">
                <!-- Button trigger modal -->
                <div class="col-3 d-grid" style="width: 9.5rem;">
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Generate Report
                    </button>
                </div>
                <div class="col-2 d-grid"style="width: 8.5rem;">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                    ...
                                    <td>
                                        <div class='row g-1'>
                                        <div class='col'>
                                        <form action='viewMaterial.php' class='d-grid' target='_blank' method='GET' id='view".$row['InformativeMaterialID']."' class='d-inline-block'>
