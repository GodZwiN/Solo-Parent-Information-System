    ...
    <div class="sidebar" id="side_nav">
        ...
        if($_SESSION['loggedAccount']['AccountID'] == 1) {
            echo "<hr class='h-color mx-2'>
                ...
                echo "
                <ul class='px-2'>
                    <li class='px-2 py-3 active'><a href='auditTrail.php' class='text-decoration-none d-block text-white'><i class='fa-sharp fa-solid fa-book'></i>Audit Trail</a></li>
                </ul>";
        }
        ?>
        ...
        <div class="main-content p-5">
            <div class="row mb-5">
                    <div class="col border-bottom border-danger pb-2">
                        <h1 class="fs-2 fw-bold">Audit Trail</h1>
                    </div>
                </div>
